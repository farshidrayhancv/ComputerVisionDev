...
def parse_args():
    ...
    parser.add_argument('--device', default='GPU', choices=['CPU', 'GPU', 'Ascend'], type=str)
    ...
    parser.add_argument('--resnet', default='resnet_cusmtom', choices=['resnet50', 'resnet101', 'resnet_cusmtom'], type=str)
