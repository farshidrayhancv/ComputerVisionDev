...
import mindspore.dataset.vision.c_transforms as c_vision #deprecated
import mindspore.dataset.vision as c_vision_resize
...
def resize(image, target, size, max_size=1333):
    ...
    resize_op = c_vision_resize.Resize(size, Inter.LINEAR)
    ...
    if "masks" in target:
        ...
        resize_op = c_vision_resize.Resize(size, Inter.NEAREST)
